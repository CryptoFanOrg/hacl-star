set terminal svg
set title "SHA2_512 performance"
...
set output 'bench_hash_SHA2_512_per_byte.svg'
set xrange[-1:21]
plot 'bench_hash_SHA2_512.csv' using 8:xticlabels(1) with boxes title columnheader, '' using ($0-1):8:xticlabels(1):(sprintf("%0.2f", $5)) with labels font "Courier,8" offset char 0,.5
