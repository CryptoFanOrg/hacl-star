...
set bmargin 3
set key off
set ylabel "cycles/hash"
set output 'bench_hash_SHA2_512_candlesticks.svg'
set xrange[0:21+1]
plot 'bench_hash_SHA2_512.csv' using 0:5:6:7:5:xticlabels(1) with candlesticks whiskerbars .25
