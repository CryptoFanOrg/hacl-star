...
set output 'bench_hash_SHA2_224.svg'
set xrange[-1:21]
plot 'bench_hash_SHA2_224.csv' using 5:xticlabels(1) with boxes title columnheader, '' using ($0-1):5:xticlabels(1):(sprintf("%0.0f", $5)) with labels font "Courier,8" offset char 0,.5
